...
# cant use "require_once('wp-config.php');" because it will not show if the mysql is down
# on the wordpress server, do the following:
...
function getvar1 ($var1, $var2) {
   ...
   $var2 = substr($var2, strpos($var2, "'")+1);
